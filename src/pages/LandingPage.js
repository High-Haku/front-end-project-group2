...
// const login = () => {
//     if (isLogin === true) {
//       loginButton.classNameList.add("d-none");
//     }
//   };
      ...
      <div className="card-group">
        <Container>
          <CardGroup className="p-5">
            <Card className="card border-0 p-2">
              <Card.Img
                className="icon-left icon-basket"
                width="50"
                style={{
                  filter:
                    "invert(19%) sepia(96%) saturate(5161%) hue-rotate(276deg) brightness(99%) contrast(96%)",
                }}
                variant="left"
                height="50"
                alt="Basket"
              ...
              <Card.Text className="card-text">
                Shopping any accessories and food for your cats.
              </Card.Text>
            </Card>
            <Card className="card border-0 p-2">
              <Card.Img
                className="icon icon-window"
                width="50"
                style={{
                  filter:
              ...
              <Card.Text className="card-text">
                Use the benefits of the services anywhere.
              </Card.Text>
            </Card>
            <Card className="card border-0 p-2">
              <Card.Img
                className="icon icon-book float-left"
                width="50"
                style={{
                  filter:
                    "invert(45%) sepia(64%) saturate(2946%) hue-rotate(339deg) brightness(100%) contrast(102%)",
                }}
                variant="left"
                height="50"
                alt="Book"
              ...
              <Card.Text className="card-text">
                A private community that we care each others.
              </Card.Text>
            </Card>
          </CardGroup>
        </Container>
